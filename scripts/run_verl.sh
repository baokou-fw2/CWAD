...
# =============================================================================
# The raw verl launcher: the only place that builds the Hydra invocation for
# verl.trainer.main_ppo. scripts/train.sh calls it last and passes every real
# value as an override, so the constants below are fallbacks for a hand-run
# invocation, not the recipe this repository documents.
# =============================================================================
...
EXPERIMENT_NAME="CWAD-${MODEL_NAME}"
PROJECT_NAME="CWAD"
TRAINER_DEFAULT_LOCAL_DIR="${CWAD_LAUNCHER_CHECKPOINT_DIR:-${PROJECT_ROOT}/checkpoints/${EXPERIMENT_NAME}}"
TRAINER_ROLLOUT_DATA_DIR="${CWAD_LAUNCHER_ROLLOUT_DIR:-${PROJECT_ROOT}/rollouts/${EXPERIMENT_NAME}}"
